...
async def _(event):
    ...
    if input_str == "sinickcerita":
        ...
        animation_chars = [
            "`Cerita Dulu BossKu` ", " .type Sejak aku putus dari kekasihku, aku menjadi sangat depresi. Aku merasa hidupku tak ada gunanya lagi. Bagaimana tidak? hubungan yang telah kubina selama 6 tahun harus kandas begitu saja. Aku telah menjalani hubungan yang panjang dan terlalu jauh bersamanya.
