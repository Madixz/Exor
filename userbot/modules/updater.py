...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('`**Exor** Berhasil Di Update!`')
    await asyncio.sleep(1)
    await event.edit('`Exor Di Restart....`')
    await asyncio.sleep(1)
...
async def upstream(event):
    ...
    if conf is None and force_update is False:
        changelog_str = f'**UPDATE Terbaru Untuk 🌀 Exor 🌀 [{ac_br}]:\n\nPERUBAHAN:**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('`Proses Update, ....🛠️`')
        await event.edit('`Proses Update, loading....🛠️`')
        await event.edit('`Proses Update, updating....🛠️`')
        await event.edit('`Proses Update silahkan tunggu....🛠️`')
    if conf == "now":
